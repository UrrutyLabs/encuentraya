...
interface UseAvailableBookingTimesOptions {
...
/**
 * Hook to generate and filter available booking times
 * Generates times at hour and half-hour intervals
 * Filters out times that are too soon when date is today
 */
export function useAvailableBookingTimes(
  date: string,
  today: string,
  selectedTime: string,
  setSelectedTime: (time: string) => void,
  options: UseAvailableBookingTimesOptions = {}
): {
